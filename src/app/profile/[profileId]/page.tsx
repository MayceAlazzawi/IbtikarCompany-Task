...
export default function page({ params: { id } }: Params) {
    console.log(id)
  return (
    <div className="profile-page flex items-center justify-center flex-col bg-[#f3f7f7] my-8 w-full h-screen">
    <div className="relative flex flex-col bg-white break-words w-5/6 sm:w-3/4 shadow-xl rounded-lg xl:h-[630px] bg-white">
      <div className="px-1 md:px-6 ">
        <div className="flex flex-wrap justify-center">
          <div className="flex flex-row justify-between items-center w-full">
            <div className="w-1/2 lg:w-4/12 px-1 order-2 text-center lg:self-center">
              <div className="flex py-4 lg:pt-4 flex justify-end ">
                {/* <div className="justify-center text-center flex flex-col md:flex-row">
                  <span className="text-sm text-gray-500 tracking-[0.1rem] px-1">
                    Last update:
                  </span>
                  <span className="text-sm font-semibold block uppercase tracking-[0.01rem] text-black">
                    {users.users[0].firstName}
                  </span>
                </div> */}
              </div>
            </div>
            <div className="w-1/2 lg:w-4/12 px-1 order-1 text-center lg:self-center">
              <div className="py-6 sm:mt-0">
                {/* <p className="uppercase text-[#04b760] font-bold shadow text-xs px-4 py-2 rounded border border-[#04b760] sm:w-2/3">
                  Total score: 
                </p> */}
              </div>
            </div>
        ...
        <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
          <div className="flex flex-wrap justify-center">
            <div id="fullWidthTabContent">
              ...
              >
                {/* <dl className="flex flex-row max-w-screen-xl grid-cols-2 gap-10 p-4 mx-auto text-gray-900 sm:grid-cols-4 xl:grid-cols-4 sm:p-8">
                  {studentInfo.hackerRank !== 0 ?
                    <div className="flex flex-col items-center justify-center">
                      <Link
                        href={
                          studentInfo.hackerRankProfile
                            ? studentInfo.hackerRankProfile
                            : ""
                        }
                        target="_blank"
                      ...
                      <dt className="mb-2 text-3xl font-extrabold">
                        {studentInfo.hackerRank}
                      </dt>
                      <dd className="text-gray-500 ">HackerRank</dd>
                    </div>
                    :
                   null
                  }
                  {studentInfo.leetCode !== "0" ?
                    <div className="flex flex-col items-center justify-center">
                      <Link
                        href={
                          studentInfo.leetCodeProfile
                            ? studentInfo.leetCodeProfile
                            : ""
                        }
                        target="_blank"
                      ...
                      <dt className="mb-2 text-3xl font-extrabold">
                        {studentInfo.leetCode}
                      </dt>
                      <dd className="text-gray-500 ">Leetcode</dd>
                    </div>
                    :
                  null
                  }
                  ...
                  {studentInfo.kattis !== 0 ?
                    <div className="flex flex-col items-center justify-center">
                      <Link
                        href={
                          studentInfo.kattisProfile
                            ? studentInfo.kattisProfile
                            : ""
                        }
                        target="_blank"
                      ...
                      <dd className="text-gray-500 ">Kattis</dd>
                    </div>
                    :
                   ""
                  }

                  {studentInfo.codeForces !== 0 ?
                    <div className="flex flex-col items-center justify-center">
                      <Link
                        href={
                          studentInfo.codeForcesProfile
                            ? studentInfo.codeForcesProfile
                            : ""
                        }
                        target="_blank"
                      >
                        <Image
                          src="/assets/images/code-forces-3628695-3029920.webp"
                          alt="codeforces"
                          width={100}
                          height={100}
                        />
                      ...
                      <dt className="mb-2 text-3xl font-extrabold">
                        {typeof studentInfo.codeForces !== "number"
                          ? "0"
                          : studentInfo.codeForces}
                      </dt>
                      <dd className="text-gray-500 ">CodeForces</dd>
                    </div>
                    :
                   ""
                  }
